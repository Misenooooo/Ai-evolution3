...
public class SelectiveBreeding {
    ...
    private List<Monk> Tournament2(List<Monk> monks) {
     ...
     List<Monk> roulette(List<Monk> monks) { // TODO toto treba dorobit a otestovat, este treba vypisat nejake vysledky do suboru, potom napisat nejaku dokumentaciu do kodu, normalnu pdf dokumentaciu a este umoznit zadat vstup
         List<Monk> newMonks = new ArrayList<>();
         Monk parent1 = null;
         Monk parent2 = null;
         ...
         for ( ; i  < monks.size();i++ ) // TODO dorobit aj toto
         {
           //  child = copier.copy(parent1);
           //  child.init();
           //  newMonks.add(child);
